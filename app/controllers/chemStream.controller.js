...
const ChemStream = db.chemStream;
...
exports.findAll = (req, res) => {
    ...
    ChemStream.findAll({ where: condition, order: ChemStream.sequelize.literal('id DESC') })
        .then(data => {
            res.send(data);
        })
        .catch(err => {
